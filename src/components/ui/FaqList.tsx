      ...
      {faqs.map((faq) => (
        ...
        >
          <summary className="flex min-h-20 cursor-pointer list-none items-center justify-between gap-6 py-5 text-left marker:content-none sm:min-h-24 sm:py-6">
            <span
              className="font-display text-xl font-black tracking-[-0.03em] text-brand-deep sm:text-2xl"
              itemProp="name"
            >
              {faq.question}
            </span>
          ...
          >
            <p
              className="max-w-3xl pb-7 pr-12 text-base leading-7 text-ink-muted sm:pb-8 sm:pr-16 sm:leading-8"
              itemProp="text"
            >
              {faq.answer}
            </p>
