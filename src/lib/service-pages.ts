...
export const commercialServicesPage = {
  ...
  intro: `${site.name} works with commercial property teams, contractors, and municipal partners across ${site.serviceArea} on underground sewer, water, drainage, excavation, and utility trenching. We are set up for clear project communication and practical field work—without unsupported certification or procurement claims.`,
  ...
  scope: [
    ...
    "Contractor support on underground utility scopes that fit our confirmed services",
  ...
  process: [
    ...
    },
    {
      ...
      body: "We review whether the scope matches our confirmed sewer, water, drainage, excavation, or utility trenching capabilities.",
    },
    {
      step: "03",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Yes. ${site.name} supports contractors and municipal or public-agency partners when the underground utility scope fits our confirmed capabilities. We do not publish unsupported certification, bonding, or procurement claims on this site.`,
    },
    {
