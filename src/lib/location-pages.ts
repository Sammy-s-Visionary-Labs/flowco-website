...
export const toledoServiceAreaPage = {
  ...
  servicesDescription: `These are the confirmed ${site.name} services Toledo property owners, businesses, contractors, and municipal partners can request.`,
  ...
  localContext: [
    ...
    "Contractors and municipal partners working in Toledo need a specialist underground utility crew that stays within confirmed sewer, water, drainage, and excavation scopes.",
  ],
  nearbyCommunities: site.primaryCities.filter((city) => city !== "Toledo"),
  nearbyDescription: `From Toledo, ${site.name} also serves nearby ${site.serviceArea} communities. Dedicated pages for those cities will be added as unique local content is ready—this Toledo page is not a template waiting for a city-name swap.`,
